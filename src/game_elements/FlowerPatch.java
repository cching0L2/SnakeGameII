...
public class FlowerPatch extends ObstacleElements{

    Position position;
    int HEIGHT = 1, LENGTH = 1;
    static ImageIcon bushImage = Util.createImageIcon("flower", "../image/flower.gif");
    
    public FlowerPatch(Position position){
